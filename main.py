...
def add_person():
    ...
    surname = input('Введите отчество: ')   #'Иванович'
    phone = input('Введите номер телефона: ') #'9784561230'
    data = open('C:\\Users\\User\\Searches\\Desktop\\Python\\phonebook.txt' ,'a', encoding='utf-8')
    data.writelines([last_name,' ',  name, ' ',  surname, ' ', phone, '\n']) # 1-й вар.
    #data.writelines([last_name + ' ',  name + ' ',  surname + ' ', phone]) #2-й вар.
    data.close()

def print_data():
    with open('C:\\Users\\User\\Searches\\Desktop\\Python\\phonebook.txt', 'r', encoding='utf-8') as data:
        print(data.read())
...
def delet_person():
    ...
    with open('C:\\Users\\User\\Searches\\Desktop\\Python\\phonebook.txt', 'w+', encoding='utf-8') as data:
        d = data.readlines()
